...
(() => {
  ...
  // Extract sources from assistant reply (lightweight heuristic)
  ...
  els.gen11.addEventListener("click", () => { els.refInput.value = "Genesis 1:1"; syncRefState(); els.input.focus(); });
